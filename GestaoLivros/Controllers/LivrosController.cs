    ...
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Livros != null ? 
                          ...
                          Problem("Entity set 'LivroContext.Livros'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Isbn,Autor")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Isbn,Autor")] Livro livro)
        {
            if (id != livro.Id)
            {
                return NotFound();
